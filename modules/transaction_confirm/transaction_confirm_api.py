...
from .transaction_confirm_schema import TransactionConfirmCreateRequest, TransactionConfirmResponse


class TransactionConfirmAPI:
    """交易确认客户端API"""
    ...
    def get(self, id: str) -> TransactionConfirmResponse:
        """获取交易确认"""
        result = self._request("GET", f"/api/v1/transaction-confirm/{id}")
        return TransactionConfirmResponse(**result)
